...
**Project summary:** {{steps.Task Decomposition.output}}
**Current milestone:** {{input.current_milestone}} (e.g., midpoint check-in, pre-assembly review)
**Task tracker status:** {{steps.Task Decomposition.output}}
...
- **What is going well:** Identify two to three specific things this member has done effectively. Be concrete — "Your literature review section cites 14 sources and synthesizes them by theme rather than summarizing each one individually" is useful. "Good work" is not.
...
**Step 4 — Recommendations.** Based on the feedback and assessment, provide three to five prioritized recommendations for the group's next phase of work. Focus on the actions most likely to improve the final submission quality.
