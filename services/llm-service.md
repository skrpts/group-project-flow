...
id: llm-service
title: LLM Service
description: "Language model service providing project coordination and academic collaboration capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for project coordination and academic collaboration. Used by all skills in this skrpt.
